    ...
    <div>
      <div className="flex flex-col w-full p-4 mt-6 bg-white rounded shadow-xl stats-item dark:bg-gray-825">
          ...
          <div id="sources" class="flex justify-between w-full">
            ...
            <ul class="flex text-xs font-medium text-gray-500 dark:text-gray-400 space-x-2">
              ...
              <li
                onClick={() => {
                  setSourceActive(2);
                  setSourceParameter('utm_mediums');
                }}
              ...
              <li
                onClick={() => {
                  setSourceActive(3);
                  setSourceParameter('utm_sources');
                }}
                className={`hover:text-indigo-600 cursor-pointer ${
                  sourceActive == 3
                    ? `text-indigo-700  border-b-2 border-indigo-700`
              ...
              <li
                onClick={() => {
                  setSourceActive(4);
                  setSourceParameter('utm_campaigns');
                }}
                className={`hover:text-indigo-600 cursor-pointer ${
                  sourceActive == 4
                    ? `text-indigo-700  border-b-2 border-indigo-700`
        ...
        <div className="h-[350px] overflow-auto">
          {!sourceLoading && <SourceDataComponent data={sourceData} />}
          {sourceLoading && (
